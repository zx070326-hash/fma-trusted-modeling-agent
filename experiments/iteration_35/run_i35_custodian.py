"""Run the frozen I35 source custodian without exposing source identity."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = materialize_unseen_world_bank_campaign_v56(
        ...
        private_target_key_id="i35-local-private-target-key",
        private_target_key=Path(args.private_target_key).read_bytes(),
        source_provenance_key_id="i35-local-source-provenance-key",
        source_provenance_key=Path(args.source_provenance_key).read_bytes(),
        custodian_host_id="same-host-logical-custodian-i35",
        coordinator_host_id="same-host-logical-coordinator-i35",
        generator_host_id="same-host-logical-generator-i35",
        custody_key_id="i35-local-custody-signing-key",
    ...
    receipt = {
        "schema_version": "5.6-i35-custodian-execution",
